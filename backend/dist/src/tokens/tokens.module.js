...
const internal_tokens_controller_1 = require("./internal-tokens.controller");
let TokensModule = class TokensModule {
};
exports.TokensModule = TokensModule;
exports.TokensModule = TokensModule = __decorate([
    (0, common_1.Module)({
        controllers: [tokens_controller_1.TokensController, internal_tokens_controller_1.InternalTokensController],
